...
export default function Home({ data }) {
  ...
  return (
    <>
      ...
      <div className='flex flex-row justifyz'>
        {sidebar && <Sidebar onExit={() => { setSideBar(false) }} />}
        <Button btnText={"Filters"} icon="/filters.svg" position={"fixed"} top={"5%"} left={"4%"} onClick={()=>setSideBar(!sidebar)} />
        <Map results={data} />
